...
import 'package:learn/apps/school/model/document_section_model.dart';
...
class DocumentSectionController extends GetxController {
  ...
  Future<void> getDocumentSectionList() async {
    ...
    if (response.statusCode == 200) {
      ...
      _documentSectionList
          .addAll(DocumentSectionModel.fromJson(response.body).section);
      print(response.body);
      update();
      _isLoaded = true;
    } else {}
  ...
  Future<void> getDocumentSectionListByID(int id) async {
    Response response =
        await documentSectionRepo.getDocumentSectionListByID(id);
    if (response.statusCode == 200) {
      //print("got Products====================================");
      _documentSectionList = [];
      _documentSectionList
