...
import 'package:learn/apps/school/presentation/page/documents/components/section_card.dart';
import 'package:learn/apps/school/presentation/page/documents/section_pdf_viewer.dart';
...
class SectionList extends StatefulWidget {
  ...
  const SectionList({Key? key, required this.docId, required this.document})
      : super(key: key);
  @override
...
class _SectionListState extends State<SectionList> {
  ...
  Widget build(BuildContext context) {
    Get.find<DocumentSectionController>()
        .getDocumentSectionListByID(widget.docId);

    return GetBuilder<DocumentSectionController>(builder: (sectionController) {
      return sectionController.isLoaded
          ? ListView.builder(
                  ...
                  onTap: () {
                    Get.to(
                        () => SectionPDFView(
                              ...
                              documentSectionController: sectionController,
                            ),
