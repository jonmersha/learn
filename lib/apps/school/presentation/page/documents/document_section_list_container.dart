...
import 'package:learn/apps/school/presentation/page/documents/document_section.dart';
...
import 'package:learn/apps/school/presentation/widget/expandable_text.dart';
...
class DocumentSectionListContainer extends StatelessWidget {
  ...
  const DocumentSectionListContainer(
      {Key? key,
      required this.documentModel,
      required this.documentSectionController})
      : super(key: key);
  @override
                  ...
                  GestureDetector(
                      onTap: () {
                        ...
                        Get.find<DocumentSectionController>()
                            .getDocumentSectionListByID(documentModel.iD!);
                      },
                      child: const AppIcon(
