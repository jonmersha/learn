...
import 'package:learn/apps/school/presentation/page/service/component/detail_service_card.dart';
import 'package:learn/apps/school/presentation/page/service/main_service_list_container.dart';
...
class _DetailServiceListState extends State<DetailServiceList> {
  ...
  Widget build(BuildContext context) {
    ...
    return GetBuilder<ServiceListDetailController>(
        builder: (serviceListDetailController) {
      return serviceListDetailController.isLoaded
          ? ListView.builder(
              ...
              itemBuilder: (context, index) {
                return GestureDetector(
                  onTap: () {
                    Get.to(
                        () => DetailServiceListContainer(
                            serviceModel: serviceListDetailController
                        ...
                        Container(
                          ...
                          decoration: BoxDecoration(
                              ...
                              image: DecorationImage(
                                  fit: BoxFit.cover,
                                  image: NetworkImage(AppConstants.IMAGE_URL +
                                      serviceListDetailController
                                          .serviceDetailList[index]
                                          .serviceIconPath!))),
                        ),
                        Expanded(
                          child: Container(
                            ...
                            child: Padding(
                              ...
                              child: DetailserviceCard(
                                  serviceDetail: serviceListDetailController
                                      .serviceDetailList[index]),
                            ),
                          ),
                        ),
