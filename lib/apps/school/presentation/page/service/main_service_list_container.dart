...
import 'package:learn/apps/school/presentation/page/service/detail_service_list.dart';
...
class DetailServiceListContainer extends StatelessWidget {
  ...
  const DetailServiceListContainer({Key? key, required this.serviceModel})
      : super(key: key);
  @override
            ...
            child: Column(
              children: [
                Container(
                    ...
                    child: ExpandableTextWidget(text: serviceModel.name!)),
